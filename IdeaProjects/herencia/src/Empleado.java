public class Empleado extends Persona{
    ...
    public Empleado(int id, String dni, String nombre, String apellido, String domicilio, int telefono, int numDeEmpleado, String cargo, Double sueldo, int socialNumber) {
